...
//base structure taken from other Audio Spectrum Analyzer project
class WavWriter {
    ...
    WavWriter(int sampleRate, String path, String fileName) {

        directoryPath = path;
        this.fileName = fileName;

        //creating the header of the wave file according the .wav specs
    ...
    boolean start() {
        ...
        outPath = new File(path, fileName + ".wav");
